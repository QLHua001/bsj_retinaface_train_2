...
from data import WiderFaceDetection, detection_collate, preproc, cfg_mnet, cfg_re50, BSJFaceData
...
parser.add_argument('--save_folder', default='./myWeights/20210627-192-three-stages-no-landmark/', help='Location to save checkpoint models')
...
if __name__ == '__main__':
    ...
    # macs, p = profile(model=retinaface, inputs=(dummy_input, ), verbose=False)
    # print(f"macs: {macs / 1000000.0}, params: {p / 1000000.0}")

    # total = sum([param.nelement() for param in retinaface.parameters()])
    # print("11111 Number of parameters: %.2fM"%(total/1e6))