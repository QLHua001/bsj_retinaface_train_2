...
def _crop(image, boxes, labels, img_dim):
    ...
    for _ in range(250):
        ...
        centers = (boxes[:, :2] + boxes[:, 2:]) / 2   # ע�⣬ �����boxes���ĸ�ֵ�����ϵ����������µ������

        # QTEST �����������ͼƬ QTEST QTEST
        mask_a = np.logical_and(roi[:2] < centers, centers < roi[2:]).all(axis=1)
        # mask_a = np.logical_and(roi[:2] < boxes[:, :2], boxes[:, 2:] < roi[2:]).all(axis=1)
        boxes_t = boxes[mask_a].copy()
        labels_t = labels[mask_a].copy()
        # landms_t = landm[mask_a].copy()
        # landms_t = landms_t.reshape([-1, landmark_num, 2]) # BSJ ���20���ؼ��� 
...
class preproc(object):
    ...
    def __call__(self, image, targets):
        ...
        image_t = _distort(image_t) # QLHUA TEST �൱�ڵ���ͼ�������ֵ
        image_t = _pad_to_square(image_t,self.rgb_means, pad_image_flag) # QLHUA TEST ��ͼƬ�Ŀ�����ͼ���ֵ���䵽��ͼ�񳤶�һ��
